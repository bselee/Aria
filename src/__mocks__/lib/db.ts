/**
 * @file    src/__mocks__/lib/db.ts
 * @purpose Vitest automatic mock for @/lib/db (PostgREST client).
 *          Identical chainable MockQueryBuilder used by the supabase shim mock.
 * @created 2026-07-08
 */

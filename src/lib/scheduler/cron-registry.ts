...
export const CRON_JOBS: CronJobDefinition[] = [
    ...
    {
        name: 'DefaultInboxIngestion',
        description: 'Ingests unread mail from bill.selee inbox into the shared email queue',
        schedule: '3,18,33,48 * * * *',
        scheduleHuman: 'Every 15 minutes (offset by 3 minutes)',
        category: 'email',
        weekdaysOnly: false,
    },
    {
        name: 'EmailOverwatchProcessing',
        description: 'Processes bill.selee inbox threads, triages promotions, and routes paid invoices',
        schedule: '6,21,36,51 * * * *',
        scheduleHuman: 'Every 15 minutes (offset by 6 minutes)',
        category: 'email',
        weekdaysOnly: false,
    },
    {
        name: 'EmailOverwatchReminderSweep',
        description: 'Evaluates PO follow-up deadlines and downstream invoice reconciliation outcomes for bill.selee',
        schedule: '11,41 * * * *',
        scheduleHuman: 'Every 30 minutes (offset by 11 minutes)',
        category: 'email',
        weekdaysOnly: false,
    },
    {

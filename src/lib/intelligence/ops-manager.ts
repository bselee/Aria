...
// REFACTOR(2026-03-19): Tracking code extracted to ../carriers/tracking-service.ts
// ~340 lines removed. See tracking-service.ts for: TRACKING_PATTERNS, carrier detection,
// FedEx OAuth, EasyPost, LTL carrier keywords, URL builders, and status parsing.

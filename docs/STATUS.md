...
- **finale/client.ts = 162 lines**: Thin facade over decomposed modules (receivings, core-client, products, purchasing, reconciler).
- **start-bot.ts = 557 lines**: Commands extracted to src/cli/commands/ modules.
